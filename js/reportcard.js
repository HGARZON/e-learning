  ...
  return $.fn.reportCard = function(options) {
    ...
    ReportCard = (function() {
      ...
      ReportCard.prototype.build = function(data) {
        ...
        html = "<h1>I've been a member of Treehouse since June 2013. Over the years I learned a lot of things :)<h1>"
        html = "<h2>At the time, i've passed " + data.badge_count + " lessons and scored " + (toThousands(data.points_total)) + " points at " + data.site + "!</h2>\n<p>Check out some of my last passed course content at the badges below: </p>\n<ul class=\"badges\">";
